...
from . import svm, process, scraping , LogisticRegression
...
#         lstm_model = tf.keras.models.load_model(r'C:\Users\user\Desktop\Fake-News-Detection-UsingMachineLearning1\Fake-News-Detection-UsingMachineLearning\Fake-News-Detection-UsingMachineLearning-master\FakeNewsDetection\models\snew_modeltfidf\lstmModel')
        
        lstmModel = tf.keras.models.load_model(r'C:\Users\user\Desktop\Fake-News-Detection-UsingMachineLearning1\Fake-News-Detection-UsingMachineLearning\Fake-News-Detection-UsingMachineLearning-master\FakeNewsDetection\models\snew_modeltfidf\lstmModel')
...
def index(request):
    ...
    if request.method == 'POST':
        ...
        if(articleDiv != ''):
            ...
            value = LogisticRegression.lr_predict(articleDiv)
            context={
                    'values': value,
        ...
        if urlll != '':
            ...
            scraping.printArticle(value)
            value = LogisticRegression.lr_predict(value)
            context={
                'values': value,
                'words':cleanedWord
            }
